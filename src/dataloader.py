...
def dataloader_generator():
    dataset = CSVGenerator(
        csv_data_file= os.path.abspath("dataraw/SKU110K_fixed/annotations/annotations_train.csv"),
        csv_class_file= os.path.abspath("dataraw/SKU110K_fixed/classes/class_mappings.csv"),
        width=2048,
        height=2048,
