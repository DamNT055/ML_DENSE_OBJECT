...
def load_config_file(opts):
    ...
    config_file_name = os.path.join(Path(__file__).parent.parent,config_file_name).replace("\\", "/")
    
    
    #D:\CAPSTONE\mlcvnets\config\detection\ssd_mobilevitv3_xx_small_320.yaml
